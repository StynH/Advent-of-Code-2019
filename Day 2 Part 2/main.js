$( document ).ready(function() {
    ...
    const endPoint = 19690720;
    let found = false;

    for(let noun in _.range(99)){
        for(let verb in _.range(99)){
            if(found) break;
            ...
            optcode[1] = parseInt(noun);
            optcode[2] = parseInt(verb);
            ...
            for(let i = 0; i < optcode.length; i += 4){
                ...
                if(done){
                    if(optcode[0] === endPoint){
                        console.log("100 x " + noun + "(noun) + " + verb + "(verb) = " + endPoint);
                        found = true;
                    }
                    break;
                }
